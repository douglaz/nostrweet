...
mod tests {
    ...
    /// Add the main tweet content (legacy version for tests)
    ...
    /// Add referenced tweets (legacy version for tests)
    ...
    /// Format a reply tweet (legacy version for tests)
    ...
    /// Format a quoted tweet (legacy version for tests)
    ...
    /// Format a retweet (legacy version for tests)
